...
<script language="javascript" src="${pageContext.request.contextPath}/resources/js/form_input.js"></script>
<!-- 
<script language="javascript" src="./resources/js/form_input.js"></script>
</head>
<body>
 -->
...
<tr>
  <td width="110"> 이메일 </td>
  <td width="400">
    <input type ="text" name ="email" size="10" style="ime-mode:inactive"> @ 
    <select name="email2">
      <option value="">메일주소선택
