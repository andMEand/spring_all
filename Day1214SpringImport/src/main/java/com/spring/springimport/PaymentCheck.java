...
public class PaymentCheck {
	...
	//public static final String IMPORT_PAYMENTIMFO_URL ="https://api.iamport.kr/payments/find/";
	
	public static final String IMPORT_CANCEL_URL ="https://api.iamport.kr/payments/cancel";
	//public static final String IMPORT_PREPARE_URL ="https://api.iamport.kr/payments/prepare";
	//
	public static final String KEY ="6458941520986447";
	
	public static final String SECRET ="S8ExaR1OkwIi1SQiTK8vaAgjjhj1McKFlpdwgekBK3UMVK4PuclFMBZ6Ti7GvSmRhznyNIayL4kHOoxj";
	//아임포트 인증(토큰)을 받아주느 함수 
	  ...
	  public int cancelPayment(String token, String mid) {
	    ...
	    try {
	      ...
	      JsonNode rootNode = mapper.readTree(enty);//mapper.readTree( 제이슨형색으로 구할 수 있다
